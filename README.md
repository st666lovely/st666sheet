...
Gửi file này **thẳng vào chat với bot** (không cần lệnh gì thêm):
- Mặc định: **merge** — cập nhật người đã có, thêm người mới, giữ nguyên người không có trong file.
- Muốn xoá sạch danh sách cũ và thay hoàn toàn bằng file mới: gửi kèm caption `ghideu` (hoặc "ghi đè").
